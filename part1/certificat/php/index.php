...
if(isset($_POST['Envoyer'])){
    ...
    if($score>60){
           $user->addCertif($_SESSION['idUser'],'php');
            $show_congrats=1;
            $pdf->AddPage('L','A4');
        
            $pdf->Image('../Modele/Modele_php.PNG',0,0,300 ,210.8);
        /*
        ...
        */
          ...
          /*
            ...
            */
            $file_name=$_SESSION['nameUser'].rand(10,9999)."PHP.pdf";
            $file=$pdf->Output("../Copie_Certificat/".$file_name,"F");
            sendmail("Bizo",$_SESSION['emailUser'],"Certificat","Your Certif PHP",$file_name);
            ob_end_flush(); 
            goto show;
    }else{
        $show_next_time=1;
