...
if(isset($_POST['Envoyer'])){
    ...
    if($score>60){
            ...
            $pdf->Image('../Modele/Modele_js.PNG',0,0,300 ,210.8);
        /*
        ...
        */
          ...
          /*
            ...
            */
            $file_name=$_SESSION['nameUser'].rand(10,9999)."JS.pdf";
            $file=$pdf->Output("../Copie_Certificat/".$file_name,"F");
            sendmail("Bizo",$_SESSION['emailUser'],"Certificat","Your Certif JS",$file_name);
            ob_end_flush(); 
            goto show;
    }else{
        $show_next_time=1;
